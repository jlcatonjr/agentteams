...
Mapping ([`agentteams/frameworks/goose.py`](frameworks.md)):
...
- [`codex_mcp_emit`](codex-mcp-emit.md) — the sibling MCP emitter that splices servers into Codex's live `.codex/config.toml`.
