...
Carved from [`analyze.py`](analyze.md) (CH-07 line ceiling) and re-exported there, so `build_manifest`
...
## See also
- [`render`](render.md) — consumes the manifest `build_manifest` assembles from these helpers.
