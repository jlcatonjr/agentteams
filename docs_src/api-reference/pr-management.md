...
For where these PR lifecycle flags sit in the broader `agentteams` command surface, see the
...
- [API Reference index](index.md) — the API hub covering every documented `agentteams` module.
