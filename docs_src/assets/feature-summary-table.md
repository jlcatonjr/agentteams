...
|----------|----------|-------------|
| **Core Pipeline** | 37 | Project ingestion, team generation, framework adapters, CLI, templates, schemas |
...
| **Migration & Update** | 9 | `--migrate`, `--revert-migration`, `--enrich`, `--auto-correct`, `--scan-security`, security flags, multi-workspace fleet update (`--fleet`) |
