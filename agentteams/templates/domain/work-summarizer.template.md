---
name: Work Summarizer — {PROJECT_NAME}
description: "Synthesizes daily, weekly, and monthly work summaries from canonical plan artifacts and git evidence for {PROJECT_NAME}; supports append-first daily capture, legacy tmp/ fallback, and required adversarial/conflict audits"
user-invokable: true
