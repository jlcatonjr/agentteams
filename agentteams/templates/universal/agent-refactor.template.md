---
name: Agent Refactor — {PROJECT_NAME}
description: "Extracts shared data to reference files and enforces spec compliance across all agent documentation in {PROJECT_NAME}"
