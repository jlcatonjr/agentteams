...
This file is the authoritative registry of repositories adjacent to **{PROJECT_NAME}** whose agent infrastructure may be affected by — or may affect — activity in this project.
