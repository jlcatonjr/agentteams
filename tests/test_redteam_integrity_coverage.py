...
#: The deployed constitutional-gate hook the enforcement manifest pins. Absent from a
#: public-release / CI checkout, which strips the deployed .claude/ instance.
_GATE_HOOK = REPO_ROOT / ".claude" / "hooks" / "constitutional-gate.py"
