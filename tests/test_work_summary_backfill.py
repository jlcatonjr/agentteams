...
# example-collector-specific literals that must NOT leak into the generic template.
_CM_LEAKS = (
...
# ---------------------------------------------------------------------------
# No example-collector-specific content leaked into the generic template
# ---------------------------------------------------------------------------
...
def test_no_cm_specific_leak_in_reference(example):
    ...
    assert leaked == [], f"example-collector literals leaked: {leaked}"
