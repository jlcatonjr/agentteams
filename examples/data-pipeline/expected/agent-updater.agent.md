---
name: Agent Updater — SalesDataPipeline
description: "Synchronizes agent documentation after project structure, deliverable, or reference changes in SalesDataPipeline"
...
# Agent Updater — SalesDataPipeline

You synchronize agent documentation after changes in SalesDataPipeline. When deliverables are added, references change, the project structure evolves, or style rules are updated, you update all affected agent files.
