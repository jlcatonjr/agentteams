...
**Style reference:** `PropertyTaxes/Whitepaper/`
...
Review for established editorial conventions documented in `PropertyTaxes/Whitepaper/`:
...
Compare prose against calibrated voice samples in `PropertyTaxes/Whitepaper/`:
