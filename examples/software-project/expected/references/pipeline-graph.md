...
![WebAppBackend agent team topology](pipeline-graph.svg)

The handoff-only control-flow backbone (agents-list edges omitted):

![WebAppBackend handoff backbone](pipeline-handoffs.svg)
...
| --- | --- | --- |
| `adversarial` | `agent-updater`, `auth-module-expert`, `content-enricher`, `orchestrator`, `tasks-api-expert`, `tool-doc-researcher`, `work-summarizer` | `conflict-auditor`, `orchestrator` |
...
| `auth-module-expert` | `orchestrator` | `adversarial`, `orchestrator`, `primary-producer` |
...
| `conflict-auditor` | `adversarial`, `agent-refactor`, `agent-updater`, `code-hygiene`, `content-enricher`, `orchestrator`, `primary-producer`, `repo-liaison`, `technical-validator`, `tool-doc-researcher`, `work-summarizer` | `agent-updater`, `conflict-resolution`, `orchestrator`, `technical-validator` |
...
| `tasks-api-expert` | `orchestrator` | `adversarial`, `orchestrator`, `primary-producer` |
| `team-builder` | — | — |
...
flowchart LR
    ...
    orchestrator -.-> auth_module_expert
...
digraph "WebAppBackend Agent Team" {
    ...
    "orchestrator" -> "auth-module-expert" [style=dashed];
    "orchestrator" -> "tasks-api-expert" [style=dashed];
