...
<!-- Document the primary classes, functions, or APIs that project code depends on from FastAPI. -->

## Common Patterns & Pitfalls

{MANUAL:TOOL_COMMON_PATTERNS}

<!-- Document common usage patterns, best practices, and known issues for FastAPI . -->

## Key Conventions

- Follow project style rules when using FastAPI
