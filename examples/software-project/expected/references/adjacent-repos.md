# Adjacent Repository Registry — WebAppBackend

This file is the authoritative registry of repositories adjacent to **WebAppBackend** whose agent infrastructure may be affected by — or may affect — activity in this project.
