---
name: Content Enricher — ResearchPaperProject
...
**Project source directory:** `html/chapters/`
...
- **Chapter component specs** (`COMPONENT_SPEC`, `COMPONENT_SECTIONS`, `COMPONENT_QUALITY_CRITERIA`):
  Read the corresponding notebook in `html/chapters/`. Extract the chapter title, section headings, and describe the learning objectives.
