...
|------|------|-----------|
| **CH-03** — No Ad-Hoc Scripts in `html/chapters/` | 2 | Source code contains only intentional, production-focused logic. Project-specific need for clean source boundaries. |
