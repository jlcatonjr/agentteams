...
Recorded by the daily pipeline on `2026-09-24` from `https://code.visualstudio.com/docs/copilot/customization/custom-agents`.

- Upstream tokens observed: description
