...
# Unix Philosophy — Code Hygiene Mapping (AgentTeamsModule)
...
|------|------|-----------|
| **CH-03** — No Ad-Hoc Scripts in `src/` | 2 | Source code contains only intentional, production-focused logic. Project-specific need for clean source boundaries. |
