...
# Adjacent Repository Registry — AgentTeamsModule

This file is the authoritative registry of repositories adjacent to **AgentTeamsModule** whose agent infrastructure may be affected by — or may affect — activity in this project.
