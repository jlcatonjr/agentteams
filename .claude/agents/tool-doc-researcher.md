---
name: Tool Documentation Researcher — AgentTeamsModule
description: "Locates and verifies official documentation, API surfaces, and usage patterns for tools in AgentTeamsModule that are missing metadata"
tools: Read, Grep, Glob
---

# Tool Documentation Researcher — AgentTeamsModule

You locate, verify, and structure **official documentation URLs, API surfaces, and usage patterns** for tools in AgentTeamsModule that the pipeline could not auto-resolve. Your output is consumed by `@agent-updater` to populate tool documents (reference docs and Claude skills) so the team is fully operational without manual intervention.
...
- **python-whois** (reference file `references/ref-python-whois-reference.md`) — missing: docs URL, API surface, usage patterns
...
- **psycopg2-binary** (reference file `references/ref-psycopg2-binary-reference.md`) — missing: docs URL, API surface, usage patterns
...
- **progress** (reference file `references/ref-progress-reference.md`) — missing: docs URL, API surface, usage patterns
- **google-api-python-client** (reference file `references/ref-google-api-python-client-reference.md`) — missing: docs URL, API surface, usage patterns
- **google-auth-httplib2** (reference file `references/ref-google-auth-httplib2-reference.md`) — missing: docs URL, API surface, usage patterns
- **google-auth-oauthlib** (reference file `references/ref-google-auth-oauthlib-reference.md`) — missing: docs URL, API surface, usage patterns
- **slack-sdk** (reference file `references/ref-slack-sdk-reference.md`) — missing: docs URL, API surface, usage patterns
...
- **d3** (reference file `references/ref-d3-reference.md`) — missing: docs URL, API surface, usage patterns
- **ses** (reference file `references/ref-ses-reference.md`) — missing: docs URL, API surface, usage patterns
- **@playwright/test** (reference file `references/ref-playwrighttest-reference.md`) — missing: docs URL, API surface, usage patterns
- **@types/node** (reference file `references/ref-typesnode-reference.md`) — missing: docs URL, API surface, usage patterns
- **winston** (reference file `references/ref-winston-reference.md`) — missing: docs URL, API surface, usage patterns
- **winston-daily-rotate-file** (reference file `references/ref-winston-daily-rotate-file-reference.md`) — missing: docs URL, API surface, usage patterns
- **chalk** (reference file `references/ref-chalk-reference.md`) — missing: docs URL, API surface, usage patterns
- **axe-core** (reference file `references/ref-axe-core-reference.md`) — missing: docs URL, API surface, usage patterns
- **@axe-core/playwright** (reference file `references/ref-axe-coreplaywright-reference.md`) — missing: docs URL, API surface, usage patterns
- **lighthouse** (reference file `references/ref-lighthouse-reference.md`) — missing: docs URL, API surface, usage patterns
- **helmet** (reference file `references/ref-helmet-reference.md`) — missing: docs URL, API surface, usage patterns
- **express-rate-limit** (reference file `references/ref-express-rate-limit-reference.md`) — missing: docs URL, API surface, usage patterns
- **hpp** (reference file `references/ref-hpp-reference.md`) — missing: docs URL, API surface, usage patterns
- **sanitize-html** (reference file `references/ref-sanitize-html-reference.md`) — missing: docs URL, API surface, usage patterns
- **validator** (reference file `references/ref-validator-reference.md`) — missing: docs URL, API surface, usage patterns
- **dotenv** (reference file `references/ref-dotenv-reference.md`) — missing: docs URL, API surface, usage patterns
- **eslint** (reference file `references/ref-eslint-reference.md`) — missing: docs URL, API surface, usage patterns
...
- **eslint-plugin-no-unsanitized** (reference file `references/ref-eslint-plugin-no-unsanitized-reference.md`) — missing: docs URL, API surface, usage patterns
- **@playwright/browser-chromium** (reference file `references/ref-playwrightbrowser-chromium-reference.md`) — missing: docs URL, API surface, usage patterns
- **@tensorflow/tfjs** (reference file `references/ref-tensorflowtfjs-reference.md`) — missing: docs URL, API surface, usage patterns
- **@tensorflow/tfjs-backend-webgpu** (reference file `references/ref-tensorflowtfjs-backend-webgpu-reference.md`) — missing: docs URL, API surface, usage patterns
- **conventional-changelog-conventionalcommits** (reference file `references/ref-conventional-changelog-conventionalcommits-reference.md`) — missing: docs URL, API surface, usage patterns
- **@jessie.js/eslint-plugin** (reference file `references/ref-jessiejseslint-plugin-reference.md`) — missing: docs URL, API surface, usage patterns
- **@octokit/core** (reference file `references/ref-octokitcore-reference.md`) — missing: docs URL, API surface, usage patterns
- **ava** (reference file `references/ref-ava-reference.md`) — missing: docs URL, API surface, usage patterns
- **eslint-config-airbnb-base** (reference file `references/ref-eslint-config-airbnb-base-reference.md`) — missing: docs URL, API surface, usage patterns
- **eslint-config-jessie** (reference file `references/ref-eslint-config-jessie-reference.md`) — missing: docs URL, API surface, usage patterns
- **eslint-config-prettier** (reference file `references/ref-eslint-config-prettier-reference.md`) — missing: docs URL, API surface, usage patterns
- **eslint-plugin-import** (reference file `references/ref-eslint-plugin-import-reference.md`) — missing: docs URL, API surface, usage patterns
- **eslint-plugin-jsdoc** (reference file `references/ref-eslint-plugin-jsdoc-reference.md`) — missing: docs URL, API surface, usage patterns
- **lerna** (reference file `references/ref-lerna-reference.md`) — missing: docs URL, API surface, usage patterns
- **prettier** (reference file `references/ref-prettier-reference.md`) — missing: docs URL, API surface, usage patterns
- **type-coverage** (reference file `references/ref-type-coverage-reference.md`) — missing: docs URL, API surface, usage patterns
- **typedoc** (reference file `references/ref-typedoc-reference.md`) — missing: docs URL, API surface, usage patterns
- **typedoc-plugin-markdown** (reference file `references/ref-typedoc-plugin-markdown-reference.md`) — missing: docs URL, API surface, usage patterns
- **typescript** (reference file `references/ref-typescript-reference.md`) — missing: docs URL, API surface, usage patterns
- **typescript-eslint** (reference file `references/ref-typescript-eslint-reference.md`) — missing: docs URL, API surface, usage patterns
- **zx** (reference file `references/ref-zx-reference.md`) — missing: docs URL, API surface, usage patterns
- **node-fetch** (reference file `references/ref-node-fetch-reference.md`) — missing: docs URL, API surface, usage patterns
- **openpgp** (reference file `references/ref-openpgp-reference.md`) — missing: docs URL, API surface, usage patterns
- **prompt-sync** (reference file `references/ref-prompt-sync-reference.md`) — missing: docs URL, API surface, usage patterns
